  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'arrow-fade': 'arrowFade 2s ease-in-out infinite',
      },
      keyframes: {
        fadeIn: {
          '0%': { opacity: '0' },
        ...
        pulseGlow: {
          '0%, 100%': { boxShadow: '0 0 20px 4px rgba(255, 215, 0, 0.5), 0 0 40px 8px rgba(255, 215, 0, 0.3)' },
          '50%': { boxShadow: '0 0 35px 10px rgba(255, 215, 0, 0.75), 0 0 60px 16px rgba(255, 215, 0, 0.45)' },
        },
        float: {
